...
namespace Com.Web.Api
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Com.Web.Api在线接口文档");
                        ...
                        // Operation filters.
                        //
                        c.OperationFilter<ConsumesContentType>();
                        //
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        c.InjectJavaScript(thisAssembly, "Com.Web.Api.Scripts.swagger_lang.js");
    ...
    /// 自定义请求类型，返回类型
    /// </summary>
    public class ConsumesContentType : IOperationFilter
    {
        /// <summary>
        /// 
        /// </summary>
